...
summary: 'Avant de pouvoir ouvrir un dossier d"assistance auprès du support technique NetApp , vous devez ajouter un compte de site d"assistance NetApp à BlueXP , puis vous inscrire pour bénéficier de l"assistance.' 
---
