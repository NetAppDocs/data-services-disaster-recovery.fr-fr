...
[role="lead"]
Configurez les autorisations ONTAP requises pour que NetApp Disaster Recovery puisse fonctionner correctement.
...
La reprise après sinistre nécessite les autorisations ONTAP suivantes :
...
Pour ajouter des autorisations dans ONTAP, créez un rôle doté des privilèges requis et attribuez-le à un utilisateur. Vous pouvez effectuer cette opération dans ONTAP à l'aide de System Manager ou de l'interface de ligne de commande ONTAP.
