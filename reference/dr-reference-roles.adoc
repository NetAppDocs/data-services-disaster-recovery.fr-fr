...
Ces rôles sont spécifiques à NetApp Disaster Recovery et ne sont pas les mêmes que les rôles de plateforme utilisés dans la console NetApp .  Pour plus de détails sur tous les rôles de la plateforme NetApp Console, consultez https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html["la documentation de configuration et d'administration de la console NetApp"^] .
