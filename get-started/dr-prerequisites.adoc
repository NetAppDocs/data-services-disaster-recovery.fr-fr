...
* Le basculement n'est pris en charge qu'avec la dernière version instantanée.  Si nécessaire, vous pouvez créer un nouvel instantané pendant la prise de cliché (c'est-à-dire que l'option d'instantané sélectif doit être désactivée).
