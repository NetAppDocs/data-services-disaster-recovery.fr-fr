...
[role="lead"]
Avant de configurer NetApp Disaster Recovery pour Kubernetes, préparez chaque cluster Kubernetes. La protection s'applique généralement à un cluster source et à un cluster de destination, effectuez donc ces procédures sur chaque cluster de la paire.
