...
[role="lead"]
Connectez-vous à NetApp Disaster Recovery via la NetApp Console.

Pour vous connecter, utilisez vos identifiants du site d'assistance NetApp ou inscrivez-vous à une connexion cloud NetApp avec votre adresse e-mail et votre mot de passe. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-logging-in.html["En savoir plus sur la connexion"^].

Des tâches spécifiques nécessitent des rôles d’utilisateur spécifiques. link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-disaster-rec-roles.html["En savoir plus sur les rôles et les autorisations des utilisateurs dans NetApp Disaster Recovery"]. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["En savoir plus sur les rôles d'accès à la NetApp Console pour tous les services"^].
...
** Si vous êtes un utilisateur de la console NetApp disposant d'un agent existant, lorsque vous sélectionnez *Reprise après sinistre*, un message concernant l'inscription apparaît.
