...
+
** Si vous n’avez pas encore ajouté d’agent de NetApp Console , vous devrez en ajouter un. Pour ajouter l'agent, reportez-vous à https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html["En savoir plus sur les agents de console"^] .
