...
[role="lead"]
Après avoir ajouté des sites vCenter, vous pouvez créer des groupes de ressources pour regrouper des groupes de machines virtuelles ou de banques de données en une seule unité. Les groupes de ressources vous permettent d'organiser un ensemble de machines virtuelles dépendantes en groupes logiques répondant à vos besoins. Par exemple, vous pouvez regrouper des machines virtuelles associées à une application ou regrouper des applications ayant des niveaux similaires. Autre exemple, les groupes peuvent contenir des ordres de démarrage différé pouvant être exécutés lors de la récupération.
...
Les groupes de ressources vous permettent de combiner des VMs ou des datastores en une seule unité.
