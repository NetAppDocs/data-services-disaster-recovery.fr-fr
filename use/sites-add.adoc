...
TIP: Assurez-vous que les vCenters source et de destination utilisent le même agent de NetApp Console .
...
+
Vous atterrirez sur la page du tableau de bord de NetApp Disaster Recovery .  Lorsque vous démarrez le service pour la première fois, vous devez ajouter des informations vCenter.  Plus tard, le tableau de bord affiche des données sur vos sites et vos plans de réplication.
...
+
** Sélectionnez un site, sélectionnez l’agent de la NetApp Console et fournissez les informations d’identification vCenter.
