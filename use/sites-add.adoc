...
+
Si c'est la première fois que vous utilisez NetApp Disaster recovery, vous devez ajouter les informations vCenter. Si vous avez déjà ajouté les informations vCenter, vous voyez le tableau de bord.
