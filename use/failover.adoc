...
Lors d'un test de basculement, la reprise après sinistre crée temporairement des machines virtuelles. Risaster Recovery mappe un datastore temporaire soutenant le volume FlexClone sur les hôtes ESXi.
