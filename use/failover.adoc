...
Lors d'un test de basculement, la reprise après sinistre crée temporairement des machines virtuelles. La reprise après sinistre mappe un datastore temporaire servant de support au volume FlexClone aux hôtes ESXi.
